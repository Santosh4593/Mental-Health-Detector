...
const Neutral = () => {
  ...
  const navigate = useNavigate();
    ...
    const fetchSurveyQuestions = async (props) => {
      try {
        ...
        const response = await fetch("http://127.0.0.1:8000/detect_emotion_and_questionnaire?emotion=neutral", {
          method: "POST",
          headers: {
  ...
  const handleSubmit = (e) => {
    ...
    const calculatedSum = userSelections.reduce((acc, currentValue) => acc + currentValue, 0);
